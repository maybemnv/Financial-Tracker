        ...
        error: (e, _) => Center(
          child: Column(
            ...
            children: [
              ...
              Text('Failed to load: $e', style: const TextStyle(color: AppTheme.textSecondary)),
              const SizedBox(height: 16),
              ElevatedButton(onPressed: () => ref.read(transactionProvider.notifier).load(), child: const Text('Retry')),
            ],
          ),
        ),
        data: (transactions) {
