...
abstract class LifecycleBridge {
  ...
  /// Register the callback that revalidates app state on resume. It must return
  /// a future that completes once fresh data is on its way; the bridge waits
  /// for the next frame after it completes, then acks.
